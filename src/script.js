...
grassColorTexture.repeat.setLength(8, 8)
grassAmbientOcclusionTexture.repeat.setLength(8, 8)
grassNormalTexture.repeat.setLength(8, 8)
grassRoughnessTexture.repeat.setLength(8, 8)
